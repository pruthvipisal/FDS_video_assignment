...
preprocessed_data_path = "https://raw.githubusercontent.com/pruthvipisal/FDS_video_assignment/refs/heads/main/preprocessed_ecommerce_dataset.csv"  # Update with actual path
